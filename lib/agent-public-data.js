...
function matchProjectScope(input = {}) {
  ...
  if (includesAny(text, ["supplier registration", "vendor registration", "reseller", "sell you", "sales pitch", "partnership pitch"])) {
...
function prepareProjectInquiry(input = {}) {
  ...
  if (match.fit === "information_only") {
    return {
      ready_for_review: false,
      route: "information_only",
      match,
      message: "Provide public information and ask for Saudi project-risk context before preparing an inquiry.",
    };
  }
