...
function classifyQuestion(question, scope) {
  ...
  if (includesAny(text, ["fit", "suitable", "qualify", "mandate criteria", "can strata help", "our project", "epc project", "delay", "variation", "fidic", "pre-litigation", "technical opinion"])) return "project_scope_fit";
