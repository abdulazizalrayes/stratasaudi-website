...
const PAGE_SEO_ROUTES = [
  { path: "/", file: "index.html", lastmod: "2026-05-30", changefreq: "weekly", priority: "1.0" },
  { path: "/about", file: "about.html", lastmod: "2026-05-30", changefreq: "monthly", priority: "0.8" },
  { path: "/services", file: "services.html", lastmod: "2026-06-09", changefreq: "weekly", priority: "0.9" },
  { path: "/counterparties", file: "counterparties.html", lastmod: "2026-05-30", changefreq: "monthly", priority: "0.8" },
  { path: "/why-saudi", file: "why-saudi.html", lastmod: "2026-05-30", changefreq: "monthly", priority: "0.8" },
  { path: "/insights", file: "insights.html", lastmod: "2026-05-30", changefreq: "weekly", priority: "0.8" },
  { path: "/faq", file: "faq.html", lastmod: "2026-06-20", changefreq: "monthly", priority: "0.8" },
  { path: "/ethics", file: "ethics.html", lastmod: "2026-05-30", changefreq: "monthly", priority: "0.7" },
  { path: "/contact", file: "contact.html", lastmod: "2026-05-30", changefreq: "monthly", priority: "0.8" },
  { path: "/privacy", file: "privacy.html", lastmod: "2026-05-30", changefreq: "monthly", priority: "0.6" },
  { path: "/terms", file: "terms.html", lastmod: "2026-05-30", changefreq: "monthly", priority: "0.6" },
  { path: "/mandate-checklist", file: "mandate-checklist.html", lastmod: "2026-05-30", changefreq: "monthly", priority: "0.7" },
  { path: "/fidic-claims-saudi-arabia", file: "fidic-claims-saudi-arabia.html", lastmod: "2026-06-09", changefreq: "monthly", priority: "0.8" },
];

const PAGE_SOCIAL_METADATA = {
  "/": {
    title: "Strata Risk Advisory | Engineering-Led Saudi Contract Risk",
  ...
  "/about": {
    title: "About Strata Risk Advisory | Saudi Project-Risk Judgment",
  ...
  "/services": {
    title: "Saudi Contract-Risk Advisory Services | Strata Risk Advisory",
  ...
  "/counterparties": {
    title: "Who Strata Advises | International Saudi Project Counterparties",
  ...
  "/why-saudi": {
    title: "Saudi Project and Contract Risk Landscape | Strata Risk Advisory",
  ...
  "/insights": {
    title: "Saudi Contract-Risk and FIDIC Insights | Strata Risk Advisory",
  ...
  "/faq": {
    title: "Saudi Contract-Risk Advisory FAQ | Strata Risk Advisory",
  ...
  "/ethics": {
    title: "Governance and Ethics | Strata Risk Advisory",
  ...
  "/contact": {
    title: "Confidential Mandate Enquiry | Strata Risk Advisory",
  ...
  "/privacy": {
    title: "Privacy | Strata Risk Advisory",
  ...
  "/terms": {
    title: "Website Terms | Strata Risk Advisory",
  ...
  "/mandate-checklist": {
    title: "Saudi Project-Risk Mandate Checklist | Strata Risk Advisory",
  ...
  "/fidic-claims-saudi-arabia": {
    title: "FIDIC Claims in Saudi Arabia | Strata Risk Advisory",
...
function publicUrlForRoute(inputPath, languageCode = "en") {
  ...
  const base = `${SITE_ORIGIN}${pathName === "/" ? "/" : pathName}`;
  return languageCode === "en" ? base : `${base}?lang=${languageCode}`;
}
...
function hreflangTags(inputPath) {
  const tags = [
    `  <link rel="alternate" hreflang="en" href="${escapeHtml(publicUrlForRoute(inputPath, "en"))}">`,
  ];
...
function applySocialMetadata(inputPath, html) {
  const route = canonicalPathForRoute(inputPath);
  const metadata = PAGE_SOCIAL_METADATA[route];
  if (!metadata) return html;

  let next = replaceOrInsertMetaName(html, "description", metadata.description);
  next = replaceOrInsertMetaProperty(next, "og:type", metadata.type || "website");
...
function applySeoMetadata(inputPath, html) {
  ...
  const canonicalUrl = publicUrlForRoute(inputPath, "en");
  ...
  next = applySocialMetadata(inputPath, next);
  ...
  if (canonicalPathForRoute(inputPath) === "/thank-you") {
    ...
    next = replaceOrInsertMetaName(next, "robots", "noindex, follow");
  }
