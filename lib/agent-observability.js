      ...
      body: JSON.stringify({
        ...
        events: [{
          ...
          params: {
            ...
            demand_classification: details.demand_classification,
            demand_record_status: details.demand_record_status,
          },
        }],
      }),
    });
...
async function recordAgentEvent(eventType, details = {}) {
  ...
  const safeDetails = {
    ...
    resource_id: safeToken(details.resource_id),
    question_topic: safeToken(details.question_topic),
    question_pattern: safeToken(details.question_pattern),
    answer_status: safeToken(details.answer_status),
    matched_service: safeToken(details.matched_service),
    language: safeToken(details.language),
    route: safeToken(details.route),
    question_fingerprint: safeToken(details.question_fingerprint),
    demand_classification: safeToken(details.demand_classification),
    demand_record_status: safeToken(details.demand_record_status),
  };
